...
window.onload = async function () {
    ...
    if (origin === "https://us-alpha.breathingworld.com") { Variables.ApiUrl = "https://us-api.breathingworld.com"; }
    else if (origin === "https://eu-alpha.breathingworld.com") { Variables.ApiUrl = "https://eu-api.breathingworld.com"; }
    else if (origin === "https://ap-alpha.breathingworld.com") { Variables.ApiUrl = "https://ap-api.breathingworld.com"; }
